...
DATA_FILE_VERSION = 1
PINNED_FINEWEB_COMMIT = "9bb295ddab0e05d785b879661af7260fed5140fc"
...
def write_datafile(filename, toks):
    ...
    header = np.zeros(DATA_HEADER_INTS, dtype=np.int32)
    header[0] = DATA_FILE_MAGIC
    header[1] = DATA_FILE_VERSION
...
fw = load_dataset("HuggingFaceFW/fineweb", name=remote_name, split="train", revision=PINNED_FINEWEB_COMMIT)
